...
fn e2e_unified_create_commands_emit_canonical_dry_run_envelopes() {
    ...
    let cases = [
        ...
        (vec!["--project", "alpha", "--json", "asset", "new", asset.as_ref(), "--dry-run"], "asset"),
        (vec!["--project", "alpha", "--json", "term", "new", "RAG", "--alias", "rag", "--dry-run"], "term"),
    ];
...
fn e2e_unified_json_data_fields_are_objects() {
    ...
    let commands = [
        ...
        vec!["--project", "alpha", "--json", "asset", "new", asset.as_ref(), "--dry-run"],
...
fn e2e_unified_help_exposes_shared_flags() {
    ...
    let mutating_commands = [
        ...
        (vec!["source", "new", "--help"], vec!["--dry-run", "--force"]),
        (vec!["asset", "new", "--help"], vec!["--dry-run", "--force"]),
