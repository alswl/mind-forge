...
// the placeholder path. project archive uses error-based not-implemented
...
fn no_commands_use_placeholder_path() {
    ...
    // - project archive returns an error-based not-implemented (stderr, not placeholder path)
}
